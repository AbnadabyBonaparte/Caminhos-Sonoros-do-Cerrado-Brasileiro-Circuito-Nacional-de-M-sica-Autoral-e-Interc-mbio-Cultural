// ==========================================
// CAMINHOS SONOROS DO CERRADO — GERADOR DE ARTE DE MARCA
// Lê chaves do ambiente. Sem chaves (ex. local), PULA sem erro.
// Salva peças em /brand (raiz do site estático) com nomes estáveis.
// ==========================================
...
const OUT = process.env.ART_OUT || 'brand'; // site estático servido da raiz → /brand/*.jpg

const cfg = JSON.parse(
  await fs.readFile(new URL('./art-direction.json', import.meta.url))
);
